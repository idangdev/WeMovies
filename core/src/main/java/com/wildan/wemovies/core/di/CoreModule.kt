package com.wildan.wemovies.core.di

import androidx.room.Room
import com.wildan.wemovies.core.data.source.local.LocalDataSource
import com.wildan.wemovies.core.data.source.local.room.MoviesDatabase
...
val databaseModule = module {
    ...
    single {
        val passphrase: ByteArray = SQLiteDatabase.getBytes("wildan".toCharArray())
...
val repositoryModule = module {
    ...
    single<IMoviesRepository> {
        com.wildan.wemovies.core.data.MoviesRepository(
            get(),
            get(),
            get()
        )
